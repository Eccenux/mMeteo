...
/**
	...
	@arrFields Array of fileds of which can look like this:
	{
		...
		,lbl: '[field label]'                             // label for the field; MUST be given for: text, date, checkbox, submit, textarea
	...
	Implemented types:
		text (url, email) - simple, short text with label on the left; url, email and such might have some special behaviour in some browsers.
